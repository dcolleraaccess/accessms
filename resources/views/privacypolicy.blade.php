    ...
    <div id="carouselExample" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{asset('img/Privacy Policy Notice And Legal Agreement stock photo - L.jpg')}}"
...
<section>
    <div class="container-xl mb-5">
        ...
        <p class="mb-4">
            ...
            created with the help of the Terms Feed Privacy Policy Generator.
        </p>
        ...
        <ul>
            <li class="my-2"><b>Account</b> means a unique account created for You to access our Service or parts of our
                Service.
            </li>
            <li class="my-2"><b>Affiliate</b> means an entity that controls, is controlled by or is under common control
                with a
                party, where “control” means ownership of 50% or more of the shares, equity interest or other securities
                entitled to vote for election of directors or other managing authority.
            </li>
            <li class="my-2"><b>Company </b>(referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement)
                refers to
                Access Healthcare Staffing, 14 Farber Road, Princeton, NJ 08540.
            </li>
            <li class="my-2"><b>Cookies </b>are small files that are placed on Your computer, mobile device or any other
                device by a
                website, containing the details of Your browsing history on that website among its many uses.
            </li>
            <li class="my-2"><b>Country </b>refers to: New Jersey, United States </li>
            <li class="my-2"><b>Device </b>means any device that can access the Service such as a computer, a cellphone
                or a digital tablet. </li>
            <li class="my-2"><b>Personal Data </b>is any information that relates to an identified or identifiable
                individual. </li>
            <li class="my-2"><b>Service </b>refers to the Website.</li>
            <li class="my-2"><b>Service Provider </b>means any natural or legal person who processes the data on behalf
            ...
            <li class="my-2"><b>Usage Data </b>refers to data collected automatically, either generated by the use of
                the Service or from the Service infrastructure itself (for example, the duration of a page visit).</li>
            <li class="my-2 overflow-scroll"><b>Website </b>refers to Access Healthcare Staffing, accessible from
                https://www.accesshealthcarestaffing.com</li>
            <li class="my-2"><b>You </b>means the individual accessing or using the Service, or the company, or other
                legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
        </ul>



        <h1 class="mt-5 mb-2">Collection and Using Your Personal Data</h1>
        ...
        <ul>
            <li class="my-2"><b>Cookies or Browser Cookies. </b>A cookie is a small file placed on Your Device. You can
            ...
            <li class="my-2"><b>Web Beacons. </b>Certain sections of our Service and our emails may contain small
        ...
        <p>
            ...
            You can learn more about cookies on TermsFeed website article.<br>
            <br>
            We use both Session and Persistent Cookies for the purposes set out below:
        </p>

        <ul>
            <li class="my-2"><b>Necessary / Essential Cookies</b> <i>Type: Session Cookies Administered by: Us</i><br>
            ...
            <li class="my-2"><b>Cookies Policy / Notice Acceptance Cookies</b> <i>Type: Persistent Cookies Administered
                    by: Us</i><br>
                Purpose: These Cookies identify if users have accepted the use of cookies on the Website.</li>
            <li class="my-2"><b>Functionality Cookies</b> <i>Type: Persistent Cookies Administered
                    by: Us</i><br>
        ...
        <h2 class="mt-4">Use Of Your Personal Data</h2>
        <p>The Company may use Personal Data for the following purposes:</p>
        <ul>
            <li class="my-2"><b>To provide and maintain our Service,</b>including to monitor the usage of our Service.
            </li>
            <li class="my-2"><b>To manage Your Account: </b>to manage Your registration as a user of the Service. The
            ...
            <li class="my-2"><b>For the performance of a contract </b>the development, compliance and undertaking of
                the
            ...
            <li class="my-2"><b>To contact You: </b>To contact You by email, telephone calls, SMS, or other equivalent
            ...
            <li class="my-2"><b>To provide You </b>with news, special offers and general information about other goods,
            ...
            <li class="my-2"><b>To manage Your requests: </b>To attend and manage Your requests to Us.</li>
            <li class="my-2"><b>For business transfers: </b>We may use Your information to evaluate or conduct a merger,
            ...
            <li class="my-2"><b>For other purposes: </b>We may use Your information for other purposes, such as data
        ...
        <ul>
            <li class="my-2"><b>With Service Providers: </b>We may share Your personal information with Service
                Providers to monitor and analyze the use of our Service, to contact You.</li>
            <li class="my-2"><b>For business transfers: </b>We may share or transfer Your personal information in
                connection with, or during negotiations of, any merger, sale of Company assets, financing, or
                acquisition of all or a portion of Our business to another company.</li>
            <li class="my-2"><b>With Affiliates: </b>We may share Your information with Our affiliates, in which case we
            ...
            <li class="my-2"><b>With business partners: </b>We may share Your information with Our business partners to
                offer You certain products, services or promotions.</li>
            <li class="my-2"><b>With other users: </b>when You share personal information or otherwise interact in the
                public areas with other users, such information may be viewed by all users and may be publicly
                distributed outside.</li>
            <li class="my-2"><b>With Your consent: </b>We may disclose Your personal information for any other purpose
                with Your consent.</li>
        </ul>

        <h2 class="mt-4">Retention Of Your Personal Data</h2>
        ...
        <h2 class="mt-4">Transfer Of Your Personal Data</h2>
        <p>
        ...
        <h2 class="mt-4">Delete Your Personal Data</h2>
        <p>
        ...
        <h2 class="mt-4 mb-4">Disclosure Of Your Personal Data</h2>
        ...
        <h3 class="mt-4">Law Enforcement</h3>
        ...
        <h3 class="mt-4">Other Legal Requirements</h3>
        <p>The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
        <ul>
            <li class="my-2">Comply with a legal obligation</li>
            <li class="my-2">Protect and defend the rights or property of the Company</li>
            <li class="my-2">Prevent or investigate possible wrongdoing in connection with the Service</li>
            <li class="my-2">Protect the personal safety of Users of the Service or the public</li>
            <li class="my-2">Protect against legal liability</li>
        </ul>

        <h2 class="mt-4">Security Of Your Personal Data</h2>
        <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the
            Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable
            means to protect Your Personal Data, We cannot guarantee its absolute security.</p>

        <br>
        <h1 class="mt-4">Children's Privacy</h1>
        <p>
        ...
        <br>
        <h1 class="mt-4">Links to Other Website</h1>
        <p>
        ...
        <br>
        <h1 class="mt-4">Changes to this Privacy Policy</h1>
        ...
        <ul>
            <li class="my-2 overflow-scroll">By email: info@accesshealthcarestaffing.com</li>
            <li class="my-2 overflow-scroll">By visiting this page on our website:
                https://www.accesshealthcarestaffing.com/privacypolicy</li>
        </ul>
    </div>
</section>
