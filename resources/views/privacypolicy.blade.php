...
<section>
    <div class="container-xl mb-5">
        ...
        <ul>
            ...
            <li class="my-2"><b>Website </b>refers to Access Healthcare Staffing, accessible from
        ...
        <ul>
            <li class="my-2">By email: info@accesshealthcarestaffing.com</li>
            <li class="my-2">By visiting this page on our website:
